...
export class LoginComponent implements OnInit {
  logForm: FormGroup ;
  constructor(private apiService:ApiAdminService, private toastr: ToastrService, private router:Router, private fb: FormBuilder) { 
  ...
  verifUser(){
    ...
    this.apiService.verifUser(data.mail, data.password).subscribe(data=>{
      ...
      if(result.ROLE!=null){  
        ...
        this.router.navigate(['/home']);
        this.toastr.success('Bienvenue '+result.NOM+" "+result.PRENOM, 'Succès',{timeOut: 2000});
       }else{
